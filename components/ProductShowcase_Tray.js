                ...
                <card className = {styles.card}>
                    ...
                    <description className = {styles.description}>
                        <div>
                            ...
                            <h2 className = {styles.skuSubtitle}>Material: {material}</h2>
                            <h2 className = {styles.skuSubtitle}>Size: {size}</h2>
                            <h2 className = {styles.skuSubtitle}>Thickness: {thickness}</h2>
                            <h2 className = {styles.skuSubtitle}>Color: {color}</h2>
                            <h2 className = {styles.skuSubtitle}>Packaging: {packaging}</h2>
                            <h2 className = {styles.skuSubtitle}>Application: {application}</h2>
                        </div>
                        <br/>
                        <div>
